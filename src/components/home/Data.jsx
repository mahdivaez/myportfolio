...
export const Data = () => {
  return (
    <div className="home__data">
      ...
      <h3 className="h3 home__subtitle">Visual Designer</h3>
      <p className="home__description">
        Welcome to my portfolio! I am Mehdi, a junior developer and lifelong
        learner based in Tehran, Iran. With a strong passion for coding and a
        dedication to continuous growth, I strive to create innovative and
        user-friendly solutions. From web development to problem-solving, I
        bring a unique blend of technical skills and a thirst for knowledge to
        every project. Let's embark on this journey of learning and create
